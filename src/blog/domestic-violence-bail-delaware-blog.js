export const DOMESTIC_VIOLENCE_BAIL_POST = {
  slug: 'how-much-is-bail-for-domestic-violence-delaware',
  title: 'How Much Is Bail for Domestic Violence in Delaware? Bail Amounts, Costs, and Release Conditions',
  metaTitle: 'How Much Is Bail for Domestic Violence in Delaware?',
  metaDescription: 'Learn how Delaware domestic-violence bail is set, what affects the amount, how bond premiums differ, and how to verify release terms.',
  category: 'Bail Process',
  date: '2026-09-07',
  image: '/images/domestic-violence-bail-delaware/domestic-violence-bail-delaware-hero.webp',
  heroImage: '/images/domestic-violence-bail-delaware/domestic-violence-bail-delaware-hero.webp',
  heroAlt: 'Delaware domestic violence bail guide with courthouse and bail document illustration',
  content: `If someone is arrested after a domestic-violence allegation in Delaware, the first question is often, “How much is bail?” There is no single domestic-violence bail amount that applies to every case. The court decides the release terms after considering the charge, alleged harm, prior record, safety concerns, and likelihood of returning to court.
